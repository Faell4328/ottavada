...
É o computador principal do sistema e atua como a **fonte da verdade** do repertório, normalmente usado pelo maestro, regente ou responsável pela organização das partituras. Podendo ter apenas um Score Maestro desse tipo.
...
É o computador utilizado para consulta ao repertório, normalmente usado na sala de ensaio, tendo permissão apenas para ler o repertório. Podendo ter um ou vários Score Maestro desse tipo.

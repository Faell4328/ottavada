...
- adicionar um relatório do que será enviado (igual o **FreeFileSync**).
  - achou muito bacana isso no "FreeFileSync" e quero muito implementar isso, trás uma sensação de controle e é muito bom isso.
  - possivelmente abrindo uma nova janela, não sei ao certo.
...
**Score Maestro** também, mas viajadas
...
**Score Maestro Server**, totalmente viajada

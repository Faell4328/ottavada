...
- [ ] Adicionar metadados em arquivos.
- [ ] Corrigir problema de música com categória aparecendo em "sem categória".
...
- Melhorar MUITO a interface.
- Padronização no nome. A ideia é que o Score Maestro consiga identificar o nome da música e padroniza-la.
- Poder ser usado para compartilhar partituras entre os músicos.
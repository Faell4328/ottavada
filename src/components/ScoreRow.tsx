      ...
      {confirmModal.isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full mx-4">
            <h2 className="text-lg font-semibold text-[#1f3a52] mb-3">
              {confirmModal.title}
            </h2>
            <p className="text-[#4a6278] mb-6">
            ...
            <div className="flex justify-end gap-3">
              <button
                ...
                className="px-4 py-2 text-[#4a6278] bg-[#e8eef7] rounded-lg hover:bg-[#dce5f0] disabled:opacity-50 transition-colors"
              >
                Cancelar
              </button>
              <button
